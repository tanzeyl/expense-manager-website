...
$user_id = $row['id']; 
$details_q = "INSERT INTO `usersplans` (`id`, `user_id`, `title`, `_from`, `_to`, `i_budget`, `n_people`, `person1`, `person2`, `reg_em`) VALUES (NULL, '$user_id', '$title', '$_from', '$_to', '$i_budget', '$n_people', '$person1', '$person2', '$reg_em')";
